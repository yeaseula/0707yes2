...
$(function () {
    $("#book_club").hover(function () {
        $("#book_club").find("img").attr("src", "img/bookclub2.JPG").css("cursor", "pointer");
    }, function () {
        $("#book_club").find("img").attr("src", "img/bookclub1.JPG").css("cursor", "pointer");
    });
});